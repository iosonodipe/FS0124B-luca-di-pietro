...
import exceptions.UnknownFunction;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Rivista rivista1 = new Rivista("rivista1", 2010, 50, Periodicita.MENSILE);
        Rivista rivista2 = new Rivista("rivista2", 2005, 50, Periodicita.ANNUALE);
        Rivista rivista3 = new Rivista("rivista1", 2000, 50, Periodicita.SETTIMANALE);
    ...
    static Scanner scanner = new Scanner(System.in);
     public static void archiveMenu(){
         ...
         try {
             ...
             if (function > 4) throw new UnknownFunction();
     ...
     private static void getElement(){
         ...
         scanner.nextLine();
         if (researchType == 0 || researchType > 3) throw new UnknownFunction();
         try {
             switch (researchType){
                 case 1:
                     System.out.print("\nInserisci ISBN: ");
